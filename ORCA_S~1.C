...
int main() {
	...
	t(LIGHTGREEN);  g(27,1);cp("¯¯¯¯¯¶±±şThe PROGSş±±Ç®®®®®");
	t(YELLOW);      g(37,2);cp("BSIT-1A");
	...
	t(WHITE);
	g(29,8);	cp("[1] Add Student");      delay(100);
	g(29,9);  cp("[2] Display Students"); delay(100);
	g(29,10); cp("[3] Search Student");   delay(100);
	g(29,11); cp("[4] Remove Student");   delay(100);
	g(29,12); cp("[5] Exit");             delay(100);


	t(YELLOW);
	g(26,16); cp("Enter your choice: ");  s("%d", &choice);
